...
def _draw_edges(ax, pos, edges, signs, mags,
    ...
    # square‑root scale gives more spread than log but still tamps extremes
...
def plot_three(wc_orig, wc_pure, wc_hyb,
    ...
    # 2) rENOMAD Δ ---------------------------------------------
    axs[1].set_title("rENOMAD", fontsize=20, pad=12)
    ...
    # 3) mENOMAD Δ ---------------------------------------------
    axs[2].set_title("mENOMAD", fontsize=20, pad=12)
