...
old_wm = np.array(read_array_from_file("/home/miles2/Escritorio/C.-Elegan-bias-Exploration/celega/Non_Biased_Dynamic_C/pattern_worm.txt"))
...
write_array_to_file(best_weight_matrix,"cheaty_worm2.txt")
